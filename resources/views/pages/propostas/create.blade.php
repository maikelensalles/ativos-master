                                ...
                                <form method="post" action="{{ route('propostas.store') }}" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group{{ $errors->has('forma_pagamento') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-forma_pagamento">Forma Pagamento</label>
                                            <input type="text" name="forma_pagamento" id="input-forma_pagamento" class="form-control form-control-alternative" placeholder="Forma Pagamento" value="{{ old('forma_pagamento') }}" required>
